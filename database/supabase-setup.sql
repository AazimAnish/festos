-- =============================================================================
-- FESTOS SUPABASE DATABASE SETUP
-- =============================================================================
-- 
...
UNION ALL
SELECT 
    'tickets' as table_name, COUNT(*) as row_count FROM public.tickets
UNION ALL
SELECT 
    'categories' as table_name, COUNT(*) as row_count FROM public.categories
UNION ALL
SELECT 
    'tags' as table_name, COUNT(*) as row_count FROM public.tags;
...
BEGIN
    ...
    RAISE NOTICE '✅ users - User accounts with wallet authentication';
    RAISE NOTICE '✅ events - Event management with blockchain integration';
    RAISE NOTICE '✅ tickets - Event registrations and purchases';
    RAISE NOTICE '✅ categories - Event categorization system';
    RAISE NOTICE '✅ tags - Flexible tagging system';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '✅ Blockchain integration support';
    RAISE NOTICE '✅ IPFS/Filebase integration';
    RAISE NOTICE '';
    RAISE NOTICE 'Next steps:';
    RAISE NOTICE '1. Test the /api/events endpoint';
    RAISE NOTICE '2. Create your first event';
    RAISE NOTICE '3. Verify data appears in discover page';
    RAISE NOTICE '';
