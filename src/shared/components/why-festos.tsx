...
import { Ticket, Sparkles, Fingerprint, MapPin } from 'lucide-react';
...
const features = [
  {
    ...
    description:
      'No fakes. No scams. Just verified tickets on Avalanche that you truly own.',
    href: '/discover',
    cta: 'Browse events',
  ...
  },
  {
    ...
    description:
      'POAP NFTs as proof of your best memories. Tickets that flex harder than wristbands.',
    href: '/poaps',
    cta: 'Explore POAPs',
  ...
  },
  {
    ...
    name: 'Resell Fairly',
    description:
      'Sell tickets in-app with capped prices. Fair for fans, transparent for everyone.',
    href: '/marketplace',
  ...
  },
  {
    ...
    description:
      'Organizers & creators earn a share on every resale. Your success is our success.',
    href: '/create',
    cta: 'Create event',
    className: 'col-span-1 sm:col-span-2 lg:col-span-1',
    background: (
        ...
        <FadeIn variant='up' timing='normal' className='space-y-10'>
          ...
          <div className='flex flex-col items-center text-center space-y-4 max-w-3xl mx-auto'>
            <h2 className='font-primary font-bold text-3xl sm:text-4xl md:text-5xl text-foreground tracking-tight'>
              ...
              <span className='text-primary'>The Same</span>
            </h2>
            <p className='font-secondary text-lg text-muted-foreground max-w-2xl'>
              Trusted by organizers, loved by fans. Your ticket is more than
              entry — it&apos;s proof you were there.
            </p>
          </div>
