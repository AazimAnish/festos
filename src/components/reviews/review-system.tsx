...
const mockReviews = [
  {
    ...
    avatar: null,
    rating: 5,
    comment: "One of the best blockchain events I've attended! Great speakers, well-organized, and amazing networking opportunities. Looking forward to the next one!",
    eventId: "event1",
    ...
    replies: [
      {
        ...
        isOrganizer: true,
        comment: "Thank you for your kind words, Alex! We're glad you enjoyed the event. Hope to see you at the next one!",
        date: "2025-01-17"
      },
      {
        userId: "user456",
        username: "Sarah Kim",
        comment: "Completely agree with your review! The workshops were outstanding.",
        date: "2025-01-18"
      }
    ]
  },
  {
    ...
    avatar: null,
    rating: 4,
    comment: "Really enjoyed the panels and workshops. The venue was a bit crowded at times, but otherwise a fantastic event with great content and speakers.",
    eventId: "event1",
    eventName: "ETHIndia 2025",
    date: "2025-01-17",
    verified: true,
  ...
  },
  {
    ...
    avatar: null,
    rating: 3,
    comment: "Good content but the event was very crowded and it was hard to network effectively. The tech demos were impressive though, and I made some valuable connections.",
    eventId: "event1",
    eventName: "ETHIndia 2025",
    date: "2025-01-18",
    verified: true,
    ...
    replies: [
      {
        ...
        username: "Event Organizer",
        isOrganizer: true,
        comment: "Thank you for your feedback, Michael. We appreciate your comments about the crowding issue and will work on improving this for future events.",
        date: "2025-01-19"
      }
    ]
  },
  {
    ...
    avatar: null,
    rating: 5,
    comment: "Absolutely phenomenal event! I learned so much from the workshops and made incredible connections. The organization was flawless.",
    eventId: "event2",
...
const mockUserReviews = [
  ...
  },
  {
    ...
    avatar: null,
    rating: 4,
    comment: "Very good conference with excellent speakers and networking opportunities. The only downside was the venue's acoustics in some rooms.",
    eventId: "event3",
...
export function ReviewSystem({ eventId, isEventPage = false }: ReviewSystemProps) {
            ...
            <div className="flex flex-col sm:flex-row gap-8 items-start sm:items-center">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex items-center mb-1">
                  {renderStars(Math.round(filteredReviews.reduce((acc, r) => acc + r.rating, 0) / filteredReviews.length))}
                </div>
              ...
              <div className="flex-1 space-y-2">
                {[5, 4, 3, 2, 1].map((num) => {
                  const count = filteredReviews.filter(r => r.rating === num).length;
      ...
      {filteredReviews.length > 0 ? (
        <div className="space-y-6">
          {filteredReviews.map((review) => (
            <Card key={review.id} className="bg-background border-border/50 rounded-xl">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <span className="font-primary font-semibold text-foreground">{review.username}</span>
                      {review.verified && (
                        <Badge variant="outline" className="bg-success/5 border-success/30 text-success text-xs">
                          <CheckCircle className="w-3 h-3 mr-1" /> Verified Attendee
                        </Badge>
                      )}
                    </div>
                    ...
                    {isEventPage && review.replies && review.replies.length > 0 && (
