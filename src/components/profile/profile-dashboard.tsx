          ...
          <FadeIn variant="up" timing="normal">
            <div className="space-y-4">
              ...
              <p className="font-secondary text-muted-foreground">
                Connect your wallet to access your personalized profile and manage your events.
              </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 items-start">
            ...
            <div className="flex-1 space-y-4">
              <div>
                ...
                <p className="font-secondary text-muted-foreground text-lg leading-relaxed mb-3">{user.bio}</p>
              ...
              <div className="space-y-2">
                <div className="flex flex-wrap gap-2">
                  {user.socialLinks.slice(0, showAllSocials ? undefined : 2).map((social) => (
                    <Button
                      key={social.platform}
                      variant="outline"
                      size="sm"
            ...
            {dashboardStatsConfig.map((stat) => (
              ...
              >
                <CardContent className="p-6 text-center">
                  <div className={`font-primary text-3xl font-bold ${stat.color} mb-2`}>
                    {user.stats[stat.key]}
                  </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card className="rounded-xl border border-border/50 bg-background shadow-sm">
                      <CardHeader>
                        <CardTitle className="font-primary text-lg">Events Created</CardTitle>
                      </CardHeader>
                      <CardContent>
                        {SAMPLE_EVENTS.length > 0 ? (
                          <div className="space-y-4">
                    ...
                    <Card className="rounded-xl border border-border/50 bg-background shadow-sm">
                      <CardHeader>
                        <CardTitle className="font-primary text-lg">Recent POAPs</CardTitle>
                      </CardHeader>
                      <CardContent>
                        {mockPOAPs.length > 0 ? (
                          <div className="space-y-4">
                            {mockPOAPs.slice(0, 3).map((poap) => (
                              <div key={poap.id} className="flex items-center gap-4 p-3 rounded-lg bg-muted/30">
                                <Image
                                  src={poap.image}
                                  alt={poap.name}
                                  width={48}
                                ...
                                <Badge 
                                  variant={poap.rarity === "legendary" ? "default" : "secondary"}
                                  className="text-xs"
                                >
                                  {poap.rarity}
                                </Badge>
            ...
            <TabsContent value="created" className="space-y-8">
              <FadeIn variant="up" timing="normal">
                <div className="flex items-center justify-between">
                  <h2 className="font-primary text-2xl font-bold text-foreground">
                    {isPersonalView ? "Events I&apos;ve Created" : `${user.name}&apos;s Events`}
                  </h2>
                  {isPersonalView && (
                    <Link href="/create">
            ...
            <TabsContent value="attending" className="space-y-8">
              <FadeIn variant="up" timing="normal">
                <div className="flex items-center justify-between">
                  <h2 className="font-primary text-2xl font-bold text-foreground">
                    {isPersonalView ? "Events I&apos;m Attending" : `Events ${user.name} is Attending`}
                  </h2>
            ...
            <TabsContent value="poaps" className="space-y-8">
              <FadeIn variant="up" timing="normal">
                <h2 className="font-primary text-2xl font-bold text-foreground mb-6">
                  {isPersonalView ? "My POAP Collection" : `${user.name}'s POAPs`}
                </h2>
