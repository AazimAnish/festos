...
export function LocationDialog({ isOpen, onClose, onLocationGranted, onLocationDenied }: LocationDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] max-w-lg mx-auto border-0 bg-background/95 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden max-h-[90vh] flex flex-col" showCloseButton={false}>
        {/* Header - Fixed */}
          ...
          <div className="text-center space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2">
              ...
              <DialogDescription className="font-secondary text-sm sm:text-base text-muted-foreground leading-relaxed max-w-sm mx-auto">
                Get personalized event recommendations and discover amazing fests happening near you
              </DialogDescription>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1 min-w-0 flex-1">
                  ...
                  <p className="font-secondary text-xs sm:text-sm text-muted-foreground leading-relaxed">
                    Find the best festivals, meetups, and events happening in your area
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-500/5 to-green-500/10 rounded-2xl p-3 sm:p-4 border border-green-500/20">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1 min-w-0 flex-1">
                  ...
                  <p className="font-secondary text-xs sm:text-sm text-muted-foreground leading-relaxed">
                    Your location is only used to show relevant events and is never shared
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-500/5 to-blue-500/10 rounded-2xl p-3 sm:p-4 border border-blue-500/20">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1 min-w-0 flex-1">
                  ...
                  <p className="font-secondary text-xs sm:text-sm text-muted-foreground leading-relaxed">
                    Explore events worldwide or stick to your local area - you&apos;re in control
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="font-secondary text-xs text-muted-foreground leading-relaxed">
                  We use your location to show nearby events and provide distance information. 
                  Your exact location is never stored or shared with third parties.
                </p>
              </div>
            </div>
          </div>
          ...
          <button
            onClick={() => {
              ...
              toast.info("🌍 Location access skipped", {
                description: "You can enable location access anytime in settings.",
                duration: 3000,
              });
            }}
            disabled={isRequesting}
