          ...
          <div className="flex items-center gap-3 lg:gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              {selectedDateTime ? (
                ...
                <span className="text-sm sm:text-base lg:text-lg">{placeholder}</span>
              )}
            </div>
          </div>
              ...
              <div className="space-y-3 pt-4 border-t border-border/50">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <Select
                      value={selectedDateTime ? selectedDateTime.getHours().toString().padStart(2, '0') : '00'}
                  ...
                  {/* Separator */}
                  <div className="text-lg sm:text-xl font-bold text-muted-foreground pt-6">:</div>
