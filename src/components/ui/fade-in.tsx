...
export function FadeIn({ 
  ...
  const timingConfigs = {
    fast: { delay: 0, duration: 0.6 },
    normal: { delay: 0, duration: 1.2 },
    slow: { delay: 0, duration: 1.8 },
    "hero-badge": { delay: 0.2, duration: 1.4 },
    "hero-text": { delay: 0.4, duration: 1.6 },
    "hero-buttons": { delay: 0.6, duration: 1.8 },
    "hero-card": { delay: 0.5, duration: 1.6 }
  };
  ...
  const variants: Record<string, MotionProps> = {
    up: {
      ...
      transition: { duration: finalDuration, delay: finalDelay, ease: "easeOut" as const }
    },
    left: {
