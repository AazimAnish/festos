  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="max-w-2xl w-full space-y-8 text-center">
          ...
          <CardContent className="p-8">
            <div className="space-y-6">
              ...
              <div>
                ...
                <Badge variant="secondary" className="bg-success/10 text-success border-success/20 px-3 py-1 rounded-3xl">
              ...
              <div className="p-4 bg-muted/30 rounded-xl">
                <div className="text-sm text-muted-foreground mb-2">Event URL</div>
        ...
        {/* Additional Actions */}
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href={`/event/manage/${eventData.uniqueId}/overview`} className="flex-1">
            <Button 
              variant="outline"
        ...
        <div className="pt-4 border-t border-border/50">
          <p className="text-sm text-muted-foreground">
            🚀 Your event is now live! Start promoting it to reach your audience.
          </p>
        </div>
      </div>
    </div>
