  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md rounded-2xl">
        <DialogHeader>
          <DialogTitle className="text-xl sm:text-2xl lg:text-3xl font-bold text-primary font-primary">Capacity Settings</DialogTitle>
        </DialogHeader>
        <div className="space-y-6 py-4">
          ...
          <div className="flex gap-3 pt-4">
            <Button variant="outline" onClick={handleRemoveLimit} className="flex-1 rounded-xl bg-transparent">
              Remove Limit
            </Button>
