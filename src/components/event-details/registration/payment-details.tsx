      ...
      <CardContent className="space-y-4">
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-medium text-foreground font-secondary">{eventPrice}</span>
          </div>
          <div className="flex items-center justify-between text-sm">
            <span className="text-gray font-secondary">Gas Fee (estimated)</span>
            <span className="font-medium text-foreground font-secondary">{gasEstimate} ETH</span>
          </div>
        </div>
        <Separator />
