...
import { Wallet, AlertCircle, CheckCircle, ArrowRight, AlertTriangle } from "lucide-react";
      ...
      <DialogContent className="max-w-md sm:max-w-lg">
        ...
        <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-secondary font-medium text-foreground">Wallet Connection</span>
                  </div>
                  {isConnected ? (
          ...
          <div className="space-y-3">
            <h4 className="font-secondary text-base font-medium text-foreground">Requirements:</h4>
            <div className="space-y-2">
              <div className={`flex items-center space-x-2 text-sm ${isConnected ? 'text-success' : 'text-gray'}`}>
                <CheckCircle className={`h-4 w-4 ${isConnected ? 'text-success' : 'text-gray'}`} />
                <span>Wallet Connected</span>
              </div>
              <div className={`flex items-center space-x-2 text-sm ${isAvalanche ? 'text-success' : 'text-gray'}`}>
                <CheckCircle className={`h-4 w-4 ${isAvalanche ? 'text-success' : 'text-gray'}`} />
