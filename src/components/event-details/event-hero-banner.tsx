      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-8 lg:p-12">
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <Badge variant="secondary" className="bg-background/90 text-foreground border-0 px-4 py-2 text-sm font-medium backdrop-blur-sm">
              {event.price}
            </Badge>
          </div>
          ...
          <div className="flex items-center gap-6 text-white/90">
            <div className="flex items-center gap-3">
              ...
              <span className="font-secondary text-lg sm:text-xl">{event.date}</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="text-2xl">🕐</span>
              <span className="font-secondary text-lg sm:text-xl">{event.time}</span>
            </div>
          </div>
        </div>
      </div>
