...
export function TicketPreview({ ticketId, poapTokenId, hasPOAP }: TicketPreviewProps) {
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-muted/20 rounded-lg border border-border">
                <span className="font-secondary text-sm text-gray">Ticket ID</span>
                <div className="flex items-center gap-2">
                  <span className="font-mono text-sm font-medium text-foreground">{ticketId}</span>
                  <TooltipProvider>
                    <Tooltip>
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="sm" className="flex-1 font-secondary text-xs">
        ...
        {hasPOAP && (
          <TabsContent value="poap" className="space-y-4 pt-4">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-muted/20 rounded-lg border border-border">
                  <span className="font-secondary text-sm text-gray">Token ID</span>
                  <div className="flex items-center gap-2">
                    <span className="font-mono text-sm font-medium text-foreground">{poapTokenId}</span>
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                ...
                <div className="flex items-center justify-between p-3 bg-muted/20 rounded-lg border border-border">
                  <span className="font-secondary text-sm text-gray">Collection</span>
                  <span className="font-secondary text-sm font-medium text-foreground">ETHIndia 2025</span>
                </div>
              </div>
