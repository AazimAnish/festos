  ...
  const filteredListings = useMemo(() => {
    return listings.filter((listing) => {
      const matchesSearch = !searchQuery || 
        ...
        listing.eventLocation.toLowerCase().includes(searchQuery.toLowerCase()) ||
    ...
    <div className="container mx-auto px-6 max-w-6xl py-8">
      ...
      {isConnected ? (
                    ...
                    <CardContent className="p-5 space-y-4">
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-muted-foreground">{listing.eventLocation}</span>
                        </div>
                      </div>
        ...
        <div className="text-center py-16">
          <h2 className="font-primary text-2xl font-bold text-foreground mb-4">Connect Your Wallet</h2>
          <p className="font-secondary text-muted-foreground mb-6">
            Please connect your wallet to access the marketplace features.
          </p>
          <Button onClick={() => toast.info("Wallet not connected. Please connect your wallet.")}>
