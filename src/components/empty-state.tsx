...
export function EmptyState({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center text-center apple-section ${className}`}
    >
          ...
          <div className='flex flex-col sm:flex-row gap-3 sm:gap-4 lg:gap-6 pt-4 lg:pt-8'>
            {action &&
              (action.href ? (
                <Link href={action.href}>
                  ...
                  >
                    {action.icon && (
                      <span className='mr-2 lg:mr-3'>{action.icon}</span>
                    )}
                    {action.label}
                  </Button>
                </Link>
            ...
            {secondaryAction &&
              (secondaryAction.href ? (
                ...
                >
                  {secondaryAction.icon && (
                    <span className='mr-2 lg:mr-3'>{secondaryAction.icon}</span>
                  )}
                  {secondaryAction.label}
                </Button>
              ))}
