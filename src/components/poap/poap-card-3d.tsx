...
export function POAPCard3D({ poap, onOpenDetails, onShare }: POAPCard3DProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Card
          className={`group overflow-hidden rounded-xl border border-border/50 bg-background shadow-sm transition-all duration-300 ease-out ${
            isHovered
              ? 'scale-[1.02] -translate-y-1 shadow-lg hover:border-border'
              : ''
