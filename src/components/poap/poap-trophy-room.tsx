...
export function POAPTrophyRoom({ poaps, onClose, onSelectPOAP }: POAPTrophyRoomProps) {
  ...
  const handlePrev = () => {
    ...
    setIsAnimating(true);
    const prevIndex = (selectedIndex - 1 + legendaryPoaps.length) % legendaryPoaps.length;
    setTimeout(() => {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-md">
        <div className="max-w-md w-full p-8 rounded-xl bg-muted/30 border-2 border-border shadow-2xl text-center">
          ...
          <h2 className="font-primary text-xl font-bold mb-2">Trophy Room Empty</h2>
          <p className="text-muted-foreground mb-6">
            You haven&apos;t collected any legendary POAPs yet. Keep attending events to earn rare collectibles!
          </p>
      ...
      <div className="relative max-w-4xl w-full p-8 z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Your legendary collection ({selectedIndex + 1} of {legendaryPoaps.length})
          </p>
        </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-center max-w-sm mx-auto">
                  ...
                  <p className="text-xs font-medium mb-1">
                    Only {selectedPOAP.totalMinted} ever minted • You own #{selectedPOAP.mintNumber}
                  </p>
