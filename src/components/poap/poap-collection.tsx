...
const mockPOAPs = [
  {
    ...
    description: "This POAP was awarded to attendees of ETH Denver 2024, one of the largest Ethereum hackathons in the world.",
    totalMinted: 2500,
    attributes: [
  ...
  },
  {
    ...
    date: "2024-01-15",
    event: "DevCon VI",
    description: "Official POAP for all attendees of DevCon VI in Colombia, the annual Ethereum developers conference.",
    totalMinted: 8500,
    attributes: [
  ...
  },
  {
    ...
    description: "Exclusive POAP awarded only to speakers at the 2024 Web3 Summit in Berlin.",
    totalMinted: 85,
    attributes: [
  ...
  },
  {
    ...
    date: "2024-04-02",
    event: "NFT.NYC 2024",
    description: "POAP for early bird ticket holders to NFT.NYC 2024, the world's leading NFT event.",
    totalMinted: 1200,
    attributes: [
      { trait: "Event Type", value: "Conference" },
  ...
  },
  {
    ...
    date: "2023-12-08",
    event: "ETHIndia 2023",
    description: "POAP awarded to all hackers who participated in ETHIndia 2023, Asia's biggest Ethereum hackathon.",
    totalMinted: 3000,
    attributes: [
      { trait: "Event Type", value: "Hackathon" },
  ...
  },
  {
    ...
    description: "Exclusive POAP awarded only to winners of the Avalanche Summit II hackathon.",
    totalMinted: 50,
    attributes: [
  ...
  },
  {
    ...
    date: "2024-04-20",
    event: "ETH Amsterdam",
    description: "POAP for all attendees of ETH Amsterdam 2024, a premier Ethereum community event.",
    totalMinted: 5000,
    attributes: [
      { trait: "Event Type", value: "Conference" },
  ...
  },
  {
    ...
    description: "Exclusive POAP for VIP attendees of Token2049 Singapore, one of Asia's premier crypto events.",
    totalMinted: 500,
    attributes: [
      { trait: "Event Type", value: "Conference" },
  ...
  },
  {
    ...
    date: "2024-02-24",
    event: "NFT Paris",
    description: "POAP awarded to all attendees of NFT Paris 2024, Europe's largest NFT event.",
    totalMinted: 4500,
    attributes: [
      { trait: "Event Type", value: "Conference" },
  ...
  },
  {
    ...
    description: "Exclusive POAP awarded only to winners of the ETHGlobal London hackathon.",
    totalMinted: 40,
    attributes: [
      { trait: "Event Type", value: "Hackathon Winner" },
...
export function POAPCollection({ username }: POAPCollectionProps) {
  ...
  const [displayMode, setDisplayMode] = useState<"grid" | "list" | "calendar">("grid");
  ...
  const handleCopyLink = () => {
    if (selectedPOAP) {
      navigator.clipboard.writeText(`https://festos.io/poap/${selectedPOAP.id}`);
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 flex-wrap justify-end">
          <Tabs 
            value={displayMode} 
            onValueChange={(value) => setDisplayMode(value as "grid" | "list" | "calendar")}
          ...
          <Button 
            ...
            onClick={() => {
              ...
              const legendaryPoaps = mockPOAPs.filter(poap => poap.rarity === "legendary");
      ...
      {filteredPOAPs.length > 0 ? (
        <FadeIn variant="up" timing="normal">
          {displayMode === "calendar" ? (
            ...
            <div className="space-y-4">
              {filteredPOAPs.map((poap) => (
                <Card key={poap.id} className="overflow-hidden rounded-xl border border-border/50 bg-background shadow-sm hover:shadow-lg hover:border-border transition-all duration-300 ease-out hover:scale-[1.01]">
                    ...
                    <CardContent className="p-4 flex-1">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
                        <div className="flex-1">
                          <h4 className="font-primary font-semibold text-foreground">{poap.name}</h4>
                      ...
                      <div className="flex items-center justify-between text-xs">
                        <div className="flex items-center gap-4">
                          <span>
                            <span className="text-muted-foreground mr-1">Mint:</span> 
        ...
        <Dialog open={isDetailDialogOpen} onOpenChange={setIsDetailDialogOpen}>
          <DialogContent className="sm:max-w-[600px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold mb-1">{selectedPOAP.event}</h3>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium">#{selectedPOAP.mintNumber}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium">{calculateRarity(selectedPOAP.mintNumber, selectedPOAP.totalMinted)}%</span>
                  </div>
                </div>
                ...
                <div className="border-t border-border pt-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {selectedPOAP.attributes.map((attr: { trait: string; value: string }, i: number) => (
                      <div key={i} className="bg-muted/30 rounded-md p-2 text-sm">
                        <div className="text-muted-foreground text-xs">{attr.trait}</div>
            ...
            <div className="flex justify-end gap-3 mt-4">
              ...
              <a href={`https://poap.xyz/scan/${selectedPOAP.id}`} target="_blank" rel="noopener noreferrer">
          ...
          <DialogContent className="sm:max-w-[400px]">
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                <h3 className="font-primary font-semibold text-lg mb-1">{selectedPOAP.name}</h3>
                <p className="text-sm text-muted-foreground">{selectedPOAP.event}</p>
              </div>
              
              <div className="flex flex-col gap-3">
                <div className="grid grid-cols-4 gap-3">
                  <Button variant="outline" size="icon" className="h-12 w-full rounded-xl">
