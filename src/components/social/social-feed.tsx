...
const mockFeedItems: FeedItem[] = [
  ...
  },
  {
    ...
    review: {
      rating: 5,
      comment: "One of the best blockchain events I've attended! Great speakers and organization."
    },
...
export function SocialFeed() {
      ...
      <div className="text-center space-y-6 max-w-md mx-auto px-6">
        <div className="space-y-4">
          ...
          <p className="font-secondary text-muted-foreground">
            Connect your wallet to see your personalized social feed and interact with other users.
          </p>
  ...
  const renderFeedItem = (item: FeedItem) => {
    switch (item.type) {
      case "event_created":
        return (
          <Card key={item.id} className="bg-background border-border/50 rounded-xl">
            <CardContent className="p-6">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <Link href={`/user/${item.user.username}`} className="font-primary font-semibold hover:underline">
                      {item.user.name}
                    </Link>
                    <span className="text-muted-foreground text-sm">created a new event</span>
                  </div>
              ...
              <Link href={`/events/${item.event.id}`} className="block">
                ...
                <h3 className="font-primary text-lg font-bold mb-2">{item.event.title}</h3>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground text-sm">is attending</span>
            ...
            <CardContent className="p-6">
              ...
              <div className="bg-muted/30 rounded-xl p-4 mb-4">
                <div className="flex mb-2">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <svg
                      key={i}
                      className={`w-4 h-4 ${i < item.review.rating ? "fill-warning text-warning" : "fill-muted text-muted"
                        }`}
              ...
              <Link href={`/events/${item.event.id}`} className="block mb-3">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-primary font-medium">{item.event.title}</h3>
        ...
        return (
          <Card key={item.id} className="bg-background border-border/50 rounded-xl">
            <CardContent className="p-6">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground text-sm">claimed a POAP for attending</span>
                    <Link href={`/events/${item.event.id}`} className="font-medium hover:underline">
                      {item.event.title}
                    </Link>
                  </div>
              ...
              <div className="flex justify-center mb-4">
                <div className="w-40 h-40 relative">
                  ...
                  <div className="absolute top-0 right-0">
                    <Badge className={`bg-gradient-to-r from-purple-400 to-pink-500 text-white shadow-lg`}>
                      {item.poap.rarity}
                    </Badge>
                  </div>
                </div>
              ...
              <h3 className="font-primary text-center text-lg font-bold mb-4">{item.poap.name}</h3>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground text-sm">purchased tickets for</span>
                    <Link href={`/events/${item.event.id}`} className="font-medium hover:underline">
                      {item.event.title}
                    </Link>
                  </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-1">
                          <Link href={`/user/${account.username}`} className="font-primary font-semibold text-sm hover:underline">
                            {account.name}
                          </Link>
                          {account.isVerified && (
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                {mockUpcomingEvents.map(event => (
                  <Link href={`/events/${event.id}`} key={event.id} className="block hover:bg-muted/20 p-2 rounded-md -mx-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-primary font-medium text-sm">{event.title}</div>
