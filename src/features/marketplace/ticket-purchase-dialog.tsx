...
export function TicketPurchaseDialog({
  ...
  const [step, setStep] = useState<
    'review' | 'confirming' | 'success' | 'error'
  >('review');
  ...
  const totalAmount = (
    parseFloat(listing.price) + parseFloat(serviceFee)
  ).toFixed(3);
              ...
              <div className='space-y-6 p-1'>
                ...
                <Card className='bg-muted/10 border-border/50'>
                  <CardContent className='p-6 space-y-4'>
                    <h4 className='font-primary font-medium'>
                      Price Breakdown
                    </h4>
                    ...
                    <div className='flex items-start gap-3'>
                      ...
                      <div className='space-y-2'>
                        ...
                        <ul className='text-sm text-amber-800 space-y-1'>
                          ...
                          <li>
                            • The ticket will be transferred to your wallet
                            immediately
                          </li>
                          <li>
                            • Gas fees are additional and will be calculated
                            during transaction
                          </li>
                          <li>
                            • You can verify ticket authenticity with the event
                            organizer
                          </li>
                        </ul>
                      </div>
                ...
                <Card className='bg-success/5 border-success/20'>
                  <CardContent className='p-4 space-y-3'>
                    <div className='flex items-center justify-between text-sm'>
                      ...
                      <div className='flex items-center gap-2'>
                        <span className='font-mono text-xs'>
                          ...
                          {purchaseResult.transactionHash.slice(-6)}
                        </span>
                        <Button
                          variant='ghost'
                          size='sm'
                    ...
                    <div className='flex items-center justify-between text-sm'>
                      ...
                      <span>
                        {new Date(purchaseResult.purchasedAt).toLocaleString()}
                      </span>
                    </div>
                  </CardContent>
                </Card>
