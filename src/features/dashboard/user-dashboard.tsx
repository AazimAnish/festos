        ...
        <div className='text-center space-y-6 max-w-md mx-auto px-6'>
          <div className='space-y-4'>
            ...
            <p className='font-secondary text-muted-foreground'>
              Connect your wallet to access your personalized dashboard and
              manage your events.
            </p>
          ...
          <Link href={stat.href} key={stat.title}>
            <Card className='group rounded-xl border border-border/50 bg-background shadow-sm hover:shadow-lg hover:border-border transition-all duration-300 ease-out hover:scale-[1.02] hover:-translate-y-1'>
              <CardContent className='p-6'>
                <div
                  className={`${stat.bgColor} w-10 h-10 rounded-full flex items-center justify-center mb-4`}
                >
                  <stat.icon className={`w-5 h-5 ${stat.color}`} />
                </div>
                <div
                  className={`font-primary text-2xl font-bold ${stat.color} mb-1`}
                >
                ...
                >
                  ...
                  <CardContent className='p-5'>
                    ...
                    <div className='mt-4 pt-4 border-t border-border'>
                      <h4 className='font-primary text-sm font-semibold mb-2'>
                        Ticket History
                      </h4>
              ...
              <CardContent className='p-0'>
                <div className='h-48 border rounded-md flex items-center justify-center bg-muted/30'>
                  <p className='text-muted-foreground'>
                    Event performance chart will appear here
                  </p>
                </div>
              ...
              <CardContent className='p-0'>
                ...
                <div className='grid grid-cols-2 gap-4 mt-6'>
                  ...
                  <div className='space-y-1'>
                    ...
                    <div className='font-primary text-lg font-bold truncate'>
                      ETHIndia 2025
                    </div>
                  </div>
                  <div className='space-y-1'>
                  ...
                  >
                    ...
                    <div className='text-right'>
                      <div className='font-primary font-semibold'>
                        {(event.joinedCount * 0.01).toFixed(2)} ETH
                      </div>
