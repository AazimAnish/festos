...
import type { EventData } from '@/shared/types/registration';
        ...
        <CardContent className='p-6'>
          <div className='flex items-center justify-between'>
            <div className='flex items-center space-x-3'>
              ...
              <span className='font-secondary text-base font-medium text-foreground'>
                POAP NFT
              </span>
            </div>
            <Badge
              variant='secondary'
              className='bg-primary/10 text-primary border-primary/20 px-3 py-1 rounded-3xl'
            >
              Claimed
            </Badge>
          </div>
